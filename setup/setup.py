...
parser.add_argument("-top", "--TopologiesPath", help = "Default directory where Topology JSON files are stored. If not given, <InstallPath>/flowgenData/Topologies will be used as default", default = "$HIBRIDA_PATH/flowgenData/Topologies", type = str)
parser.add_argument("-app", "--ApplicationsPath", help = "Default directory where Application JSON files are stored. If not given, <InstallPath>/flowgenData/Applications will be used as default", default = "$HIBRIDA_PATH/flowgenData/Applications", type = str)
parser.add_argument("-wor", "--WorkloadsPath", help = "Default directory where Workload JSON files are stored. If not given, <InstallPath>/flowgenData/Workloads will be used as default", default = "$HIBRIDA_PATH/flowgenData/Workloads", type = str)
parser.add_argument("-alo", "--AllocationMapsPath", help = "Default directory where Allocation Maps JSON files are stored. If not given, <InstallPath>/flowgenData/AllocationMaps will be used as default", default = "$HIBRIDA_PATH/flowgenData/AllocationMaps", type = str)
parser.add_argument("-clo", "--ClusterClocksPath", help = "Default directory where Cluster Clocks JSON files are stored. If not given, <InstallPath>/flowgenData/ClusterClocks will be used as default", default = "$HIBRIDA_PATH/flowgenData/ClusterClocks", type = str)
...
with open(args.InstallName + ".source", "w") as SourceFile:
    ...
    SourceFile.write("alias " + args.InstallName + "=\"python " + args.InstallPath + "/scripts/mainScript.py\"\n")
