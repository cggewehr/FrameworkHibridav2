...
class PE:
    ...
    def __init__(self, PEPos, BaseNoCPos, StructPos = None, ThreadSet = None, CommStructure = "NoC", DataWidth = 32, BridgeBufferSize = 256, BusArbiter = "RR"):
        ...
        if isinstance(ThreadSet, list) or isinstance(ThreadSet, dict):
            ...
            print("Warning: PE instantiated with no associated Thread object. This is to be expected if no Workload has been defined, or PE.__init__() is called from Platform.__init().")
