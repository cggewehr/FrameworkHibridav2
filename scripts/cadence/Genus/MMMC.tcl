...
create_library_set -name LIB_0V9 -timing {
	"${CellLibDir}/timing/slow_vdd1v0_basicCells.lib"
	"${CellLibDir}/timing/slow_vdd1v0_multibitsDFF.lib"
}

create_library_set -name LIB_1V08 -timing {
	"${CellLibDir}/timing/slow_vdd1v2_basicCells.lib"
	"${CellLibDir}/timing/slow_vdd1v2_multibitsDFF.lib"
}
...
set_analysis_view -setup {VIEW_0V9 VIEW_1V08} -dynamic {VIEW_0V9 VIEW_1V08} -leakage {VIEW_0V9 VIEW_1V08}
